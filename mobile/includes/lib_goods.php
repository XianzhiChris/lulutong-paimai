...
//                'g.is_delete = 0 AND (' . $children . 'OR ' . get_extension_goods($children) . ') ';
    $sql = "SELECT a.act_id, a.goods_id, a.act_name, a.ext_info,a.end_time,a.start_time,a.act_count,a.is_finished, g.goods_thumb, g.goods_img2,g.supplier_id,g.brand_id ".
...
//    $sql .= $order_rule;
    ...
    foreach ($res AS $idx => $row)
    {
        ...
        $goods[$idx]['chujia']=$chujia?price_format($chujia):price_format($ext_info['start_price']);
    }
