...
function action_auction_list ()
{
	...
	include_once (ROOT_PATH . 'includes/lib_clips.php');
	//$smarty->assign('prompt', get_user_prompt($user_id));
	$smarty->assign('prompt', get_user_auction($user_id));  //单独设置获取用户竞拍信息函数  李云鹏20160510
