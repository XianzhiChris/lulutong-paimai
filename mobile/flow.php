...
elseif ($_REQUEST['step'] == 'done')
{
	...
	$order = array(
        ...
        'bonus_id'        => isset($order_bonus_id) ? $order_bonus_id : 0,  //优惠券叠加 此处为数组 李云鹏20160523
   ...
   /* 判断是不是实体商品 */
    ...
    /* 拍卖佣金10%  李云鹏20160522 */
    if ($_CFG['yongjin_user'] > 0)
    {
        //$order['yongjin_name'] = "拍卖佣金";
    }
    $order['yongjin_fee']      = $total['yongjin_fee'];
