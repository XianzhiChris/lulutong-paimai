								...
								<table width="400" border="0" cellspacing="0" cellpadding="0">
									...
									<tr>
										<td valign="top" style="padding-left:10px">
											<!-- <?php $_from = $this->_var['brand_list_new']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'brand_list_0_84072300_1465378092');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_84072300_1465378092']):
?> -->
											<!-- <?php if ($this->_var['brand_list_0_84072300_1465378092']['name_p'] >= "a" && $this->_var['brand_list_0_84072300_1465378092']['name_p'] <= "g"): ?> -->

											<div id="@<?php echo $this->_var['key']; ?>">
												<div id="<?php echo $this->_var['brand_list_0_84072300_1465378092']['name_pinyin']; ?><?php echo $this->_var['brand_list_0_84072300_1465378092']['name']; ?>">
													<a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list_0_84072300_1465378092']['name']; ?>')"><?php echo $this->_var['brand_list_0_84072300_1465378092']['name']; ?></a>
												</div>
											</div>
										...
										<td valign="top" style="padding-left:10px">
											<!-- <?php $_from = $this->_var['brand_list_new']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'brand_list_0_84095100_1465378092');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_84095100_1465378092']):
?> -->
											<!-- <?php if ($this->_var['brand_list_0_84095100_1465378092']['name_p'] >= "h" && $this->_var['brand_list_0_84095100_1465378092']['name_p'] <= "k"): ?> -->

											<div id="@<?php echo $this->_var['key']; ?>">
												<div id="<?php echo $this->_var['brand_list_0_84095100_1465378092']['name_pinyin']; ?><?php echo $this->_var['brand_list_0_84095100_1465378092']['name']; ?>">
													<a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list_0_84095100_1465378092']['name']; ?>')"><?php echo $this->_var['brand_list_0_84095100_1465378092']['name']; ?></a>
												</div>
											</div>
										...
										<td valign="top" style="padding-left:10px">
											<!-- <?php $_from = $this->_var['brand_list_new']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'brand_list_0_84110900_1465378092');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_84110900_1465378092']):
?> -->
											<!-- <?php if ($this->_var['brand_list_0_84110900_1465378092']['name_p'] >= "l" && $this->_var['brand_list_0_84110900_1465378092']['name_p'] <= "s"): ?> -->

											<div id="@<?php echo $this->_var['key']; ?>">
												<div id="<?php echo $this->_var['brand_list_0_84110900_1465378092']['name_pinyin']; ?><?php echo $this->_var['brand_list_0_84110900_1465378092']['name']; ?>">
													<a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list_0_84110900_1465378092']['name']; ?>')"><?php echo $this->_var['brand_list_0_84110900_1465378092']['name']; ?></a>
												</div>
											</div>
										...
										<td valign="top" style="padding-left:10px">
											<!-- <?php $_from = $this->_var['brand_list_new']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'brand_list_0_84125100_1465378092');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_84125100_1465378092']):
?> -->
											<!-- <?php if ($this->_var['brand_list_0_84125100_1465378092']['name_p'] >= "t" && $this->_var['brand_list_0_84125100_1465378092']['name_p'] <= "z"): ?> -->

											<div id="@<?php echo $this->_var['key']; ?>">
												<div id="<?php echo $this->_var['brand_list_0_84125100_1465378092']['name_pinyin']; ?><?php echo $this->_var['brand_list_0_84125100_1465378092']['name']; ?>">
													<a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list_0_84125100_1465378092']['name']; ?>')"><?php echo $this->_var['brand_list_0_84125100_1465378092']['name']; ?></a>
												</div>
											</div>
										...
										<td valign="top" style="padding-left:10px">
											<!-- <?php $_from = $this->_var['brand_list_new']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'brand_list_0_84138100_1465378092');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_84138100_1465378092']):
?> -->
											<!-- <?php if ($this->_var['brand_list_0_84138100_1465378092']['name_p'] >= "0" && $this->_var['brand_list_0_84138100_1465378092']['name_p'] <= "9"): ?> -->

											<div id="@<?php echo $this->_var['key']; ?>">
												<div id="<?php echo $this->_var['brand_list_0_84138100_1465378092']['name_pinyin']; ?><?php echo $this->_var['brand_list_0_84138100_1465378092']['name']; ?>">
													<a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list_0_84138100_1465378092']['name']; ?>')"><?php echo $this->_var['brand_list_0_84138100_1465378092']['name']; ?></a>
												</div>
											</div>
			...
			function no_look_brand_content()
			{
				...
				<tr>
					...
					<td>
						...
						<input type="button" value="<?php echo $this->_var['lang']['compute_by_mp']; ?>" onclick="marketPriceSetted()" style="display:none" />
						<?php echo $this->_var['lang']['require_field']; ?>
					</td>
				</tr>
...
?>
				...
				<!-- 拍卖首页长方形图片  李云鹏20160426 -->
				<tr>
					<td class="label">首页710x240图片</td>
					<td>
						<input type="file" name="goods_img2" size="35" />
						<?php if ($this->_var['goods']['goods_img2']): ?>
						<a href="goods.php?act=show_image&img_url=<?php echo $this->_var['goods']['goods_img2']; ?>" target="_blank">
							<img src="images/yes.gif" border="0" />
						</a>
						<?php else: ?>
						<img src="images/no.gif" />
