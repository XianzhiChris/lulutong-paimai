...
<li class="show_8"><a href="http://www.xianzhixueyuan.com" target="_blank"><?php echo $this->_var['lang']['help']; ?></a></li>
<li class="show_7"><a href="http://www.itmba.cc"  target="_blank"><?php echo $this->_var['lang']['about']; ?></a></li>
...
-->    <li class="midd_22"><a href="index.php?act=main" target="main_frame">起始页</a></li>
    ...
    <li class="midd_1"><a href="auction.php?act=list" target="main_frame">拍卖列表<span><em></em><?php echo $this->_var['datainfo']['auction']; ?></span></a></li>
