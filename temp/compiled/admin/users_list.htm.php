...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <th><a href="javascript:listTable.sort('is_validated'); "><?php echo $this->_var['lang']['is_validated']; ?></a>邮箱是否验证</th>
...
?>
  <tr>
    ...
    <!-- #代码增加2014-12-23 by www.68ecshop.com  _star -->
    <td align="center"><?php if ($this->_var['user']['validated']): ?> <img src="images/yes.gif"> <?php else: ?> <img src="images/no.gif"> <?php endif; ?></td>
    <!-- #代码增加2014-12-23 by www.68ecshop.com  _end -->
	...
	<td><?php echo $this->_var['user']['froms']; ?></td>
    ...
    <td align="center">
	  ...
	  <a href="order.php?act=list&user_id=<?php echo $this->_var['user']['user_id']; ?>&supp=1" title="<?php echo $this->_var['lang']['view_order1']; ?>"><img src="images/icon_view.gif" border="0" height="16" width="16" /></a>
      ...
      <a href="sendmail.php?act=sendmail&email=<?php echo $this->_var['user']['email']; ?>"><img src="images/ico_email.png" border="0" height="16" width="16" /></a>
    </td>
  </tr>
  <?php endforeach; else: ?>
