...
<div class="list-div">
	<div class="important">
    	<ul class="import">
            <?php if ($this->_var['today']['sms_v'] == 1): ?>
            <li class="import_1">
                <div class="module">
                    <i></i>
                    <div class="detail">
                        <strong><?php echo $this->_var['today']['sms_yue']; ?></strong>
                        <span>短信剩余金额</span>
                    </div>
                </div>
            </li>
	...
	<div class="console-detaile">
        ...
        <div class="item goods-item">
            ...
            <div class="item-bd item-bd2">
                <ul class="clearfix">
                    <li>
                        <strong><a href="goods.php?act=list">商品总数</a></strong>
                        <span><?php echo $this->_var['goods']['self']; ?> 件</span>
                    </li>
                    <li class="li_even">
                        <strong><a href="auction.php?act=list">拍卖商品</a></strong>
                        <span><?php echo $this->_var['goods']['auction']; ?> 件</span>
                    </li>
                    <!--<li class="li_even">
