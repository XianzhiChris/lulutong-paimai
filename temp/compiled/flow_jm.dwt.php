...
?>
  ...
  <?php $_from = $this->_var['consignee_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('sn', 'consignee_0_04348500_1464704324');if (count($_from)):
    foreach ($_from AS $this->_var['sn'] => $this->_var['consignee_0_04348500_1464704324']):
?>
...
/* 处理提交地址的反馈信息  */
  function addressResponse(result)
  {
    ...
    <div class="checkBox_jm">
      <div class="title">2 送货时间 <span class="songhuo">送货时间仅作参考，我们会尽量满足您的要求</span></div>
      <div class="timebox">
        <ul>
          ...
          <td width='50%' <?php if (($this->_foreach['name']['iteration'] <= 1)): ?>style="border-top:none;"<?php endif; ?>><?php if ($this->_var['goods']['goods_id'] > 0 && $this->_var['goods']['extension_code'] != 'package_buy'): ?>
            ...
            <div class="thumb_name">
              <dl >
                ...
                <dt><img src="<?php echo $this->_var['goods']['goods_thumb']; ?>" style="border:1px solid #ddd;" title="<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>" /></dt>
                <dd> <?php echo $this->_var['goods']['goods_name']; ?> <br>
...
?>
	...
	<?php endif; ?>
        ...
        <tr>
            ...
            <?php if ($this->_var['order']['bonus_id_info2'] [ 0 ] > 0): ?>
            <div class="checkout_other2"> <a class="jmbag" href="javascript:void(0);" onclick="showCheckoutOther(this);"><span>-</span>使用优惠券</a>
            <?php else: ?>
            <div class="checkout_other"> <a class="jmbag" href="javascript:void(0);" onclick="showCheckoutOther(this);"><span>+</span>使用优惠券</a>
            <?php endif; ?>
              ...
              <table class="subbox_other" width="100%" >
                ...
                <tr><td colspan=4>
                    <ul>
                        <?php $_from = $this->_var['goodsinfo']['redbag']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('index', 'bonus');if (count($_from)):
    foreach ($_from AS $this->_var['index'] => $this->_var['bonus']):
?>
                        <li id="<?php echo $this->_var['bonus']['bonus_id']; ?>" <?php if (in_array ( $this->_var['bonus']['bonus_id'] , $this->_var['order']['bonus_id_info2'] )): ?> class="selected"<?php else: ?> class=""<?php endif; ?> onclick="changeBonus(<?php echo $this->_var['bonus']['bonus_id']; ?>,<?php echo $this->_var['key']; ?>)"><?php echo $this->_var['bonus']['type_name']; ?>[<?php echo $this->_var['bonus']['bonus_money_formated']; ?>]</li>
                        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                        <input type="hidden" name="bonus" id="bonus" value="<?php echo $this->_var['order']['bonus_id']; ?>">
                    </ul>
                </td></tr>
                <tr style="display:none">
                  <td  align=right width="120">优惠券：</td>
                  <td></td>
        ...
        <tr style="display:none">
            <td colspan="4" class="tdother2"><div class="checkout_other" > <a class="jmbag" href="javascript:void(0);" onclick="showCheckoutOther(this);"><span>+</span>使用余额</a>
                <table class="subbox_other" width="100%">
                <tr>
...
?> 
              ...
              <li>
                ...
                <img align="absmiddle" src="themes/paimai/images/jmpic/pay_<?php echo $this->_var['payment']['pay_code']; ?>.gif" alt="<?php echo $this->_var['payment']['pay_name']; ?>" /></li>
              <?php endif; ?> 
              <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
            </ul>
          </div>
    ...
    <div class="flowBox_jm clearfix" style="border:none;padding-bottom:20px;">
      ...
      <div style="float:right;width:55%;text-align:right;padding:8px 20px;"> 
        ...
        <input onclick="return check_before_submit()" type="image" src="themes/paimai/images/jmpic/btn_done.gif" align="absmiddle" />
