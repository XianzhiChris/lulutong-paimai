...
<link href="themes/paimai/css/passport.css" rel="stylesheet" type="text/css">
<script type="text/javascript" src="themes/paimai/js/jquery_email.js"></script>
<script type="text/javascript" src="themes/paimai/js/jquery-1.9.1.min.js"></script>
<script type="text/javascript" src="themes/paimai/js/placeholder.js"></script>
				...
				<div id="login-box" class="uc_box uc_box_reg">
                	<form action="register.php" method="post" id="formRegister" name="formRegister">
                        ...
                        <ul class="register_tab">
                            <li id="li_register_type_mobile" class="tab_item fl" register_type="mobile">会员注册<span class="bg_ff"></span></li>
                            <li style="display:none" id="li_register_type_email" class="tab_item cur fl" register_type="email">邮箱注册<span class="bg_ff"></span></li>
					...
					<form action="register.php" method="post" id="formUser" name="formUser" >
					    <div id="xuzhi" class="form">
					        <div id="xznr">
					            <h1>竞买须知</h1>
                                <?php echo $this->_var['jmxz']; ?>
					        </div>
					        <div class="anniu">
					            <input type="button" id="tongyi" value="同意"><input type="button" class="butongyi" value="不同意">
					        </div>
					    </div>
						<div class="form">
						<input type="hidden" name="register_type" value="<?php echo $this->_var['register_type']; ?>" />
                            ...
                            <div class="item">
                                ...
                                <div style="clear:both"><span class="label"></span></div>
                            </div>
                            <?php endif; ?>
							<div id="o-password">
								<div class="item">
...
?>
							...
							<div class="item item_t" id="form_xuzhi">
								<div class="safety">
									<input name="agreement" id="agreement" type="checkbox" value="1" class="checkbox" />
