...
<link href="themes/paimai/css/new_order_member.css" rel="stylesheet" type="text/css">
<script type="text/javascript" src="themes/paimai/js/jquery-1.9.1.min.js"></script>
          ...
          <div class="mar_top">
            <form action="" method="post" name="valueForm" id="valueForm" onSubmit="return valueLogin()">
              <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#ffffff" style="border:1px solid #ddd;border-top:1px solid #E7E7E7;">
                <tr>
                  <td colspan=2 ><img src="themes/paimai/images/takegoods/tg_title.gif"></td>
                </tr>
                <tr >
            ...
            <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#ffffff" style="border:1px solid #ddd;padding-top:35px;">
              ...
              <tr>
                ...
                <td height=30><input type="hidden" name="act" value="vc_login_act">
                  <input type="image" src="themes/paimai/images/vc_login.gif"></td>
              </tr>
              <tr>
                <td colspan=2 height=30></td>
              </tr>
...
?>
                ...
                <li <?php if ($this->_foreach['name']['iteration'] % 4 == 0): ?>style="margin:0px 0px 11px 0px"<?php endif; ?>>
                  ...
                  <p>发行店铺：<a href="<?php if ($this->_var['hong']['supplier_id'] == 0): ?>index.php<?php else: ?>supplier.php?suppId=<?php echo $this->_var['hong']['supplier_id']; ?><?php endif; ?>" target="_blank"><?php if ($this->_var['hong']['supplier_id'] == "自营商"): ?><?php echo $this->_var['hong']['supplier_id']; ?><?php else: ?><?php echo $this->_var['hong']['supplier_id']; ?><?php endif; ?></a></p>
            ...
            <tbody class="close-order">
              ...
              <tr class="order-hd">
                <td colspan="8"><span class="no">
                  ...
                  <!-- 在线客服聊天
                  <a href="javascript:chat_online({chat_order_id: '<?php echo $this->_var['item']['order_id']; ?>'});" title="联系客服"><img src="themes/paimai/images/chat/web_logo.png" width="16" height="16" style="vertical-align:top;"/></a>
                   -->
                  </td>
              </tr>
...
?>
                  ...
                  <div class="goods_desc <?php if (($this->_foreach['goods']['iteration'] == $this->_foreach['goods']['total'])): ?>last<?php endif; ?>"> <a class="pic" <?php if ($this->_var['goods']['goods_id'] > 0 && $this->_var['goods']['extension_code'] != 'package_buy'): ?>href="<?php if ($this->_var['goods']['extension_code'] == 'virtual_good'): ?>virtual_group_goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?><?php else: ?><?php echo $this->_var['goods']['url']; ?><?php endif; ?>"<?php else: ?><?php endif; ?> title="查看宝贝详情" target="_blank"> 
                    ...
                    <img src="themes/paimai/images/jmpic/ico_cart_package.gif" alt="查看宝贝详情" width="50" height="50"/>
                    <?php endif; ?> 
                    </a>
                ...
                <a href="javascript:;" class="nav_a">物流跟踪</a></div>
                    <div id="subNav_<?php echo $this->_var['item']['invoice_no']; ?>" class="wuliu" style="display:none; position:absolute;">
                      <div class="wuliu_info">
                        ...
                        <div><img src="themes/paimai/images/drop.gif" width="12" height="12" onclick="hiddenSubNav('subNav_<?php echo $this->_var['item']['invoice_no']; ?>')" /></div>
                      </div>
                      <?php if ($this->_var['item']['result_content']): ?> 
...
?> 
			...
			#back_order_img_list div {float:left; margin:0 10px 10px 0;}
                  ...
                  <div><img id="back_order_img" src="themes/paimai/images/back_order_img.gif" /></div>
          ...
          <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#E6E6E6">
            <tr>
              <td align="right" bgcolor="#ffffff"> <?php echo $this->_var['lang']['goods_all_price']; ?><?php if ($this->_var['order']['extension_code'] == "group_buy"): ?><?php echo $this->_var['lang']['gb_deposit']; ?><?php endif; ?>: <?php echo $this->_var['order']['formated_goods_amount']; ?> 
                ...
                <?php endif; ?>
                <?php if ($this->_var['order']['yongjin_fee'] > 0): ?>
                + 拍卖佣金: <?php echo $this->_var['order']['formated_yongjin_fee']; ?>
                <?php endif; ?></td>
            </tr>
            <tr>
