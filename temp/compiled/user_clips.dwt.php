      ...
      <div class="clearfix usBox_y"> 
        ...
        <div class="account">
          <div class="money">
            <ul class="clearfix">
              <li class="first">
                <div class="title"><span>账号余额(<em>充值</em>|<em>提现</em>)</span></div>
              ...
              <li class="second">
                <div class="title"><span>优惠券</span></div>
                ...
                <li>
                  <ul class="img clearfix">
                    <li style="position:relative"> <a href="user.php?act=order_detail&order_id=<?php echo $this->_var['jiao']['order_id']; ?>" title="<?php echo $this->_var['jiao']['goods_name']; ?>" target="_blank"> 
                      ...
                      <img src="themes/paimai/images/jmpic/ico_cart_package.gif" border="0" title="<?php echo htmlspecialchars($this->_var['jiao']['goods_name']); ?>" />
                      <?php endif; ?> 
...
?>
          ...
          <div class="middle exchange" style="display:none">
            <div class="line1 clearfix">
...
?>
            ...
            <?php endif; ?> </div>
          <div class="middle history" style="display:none">
            <div class="line1 clearfix">
                  ...
                  <form action="user.php" method="post" enctype="multipart/form-data" name="formMsg" onSubmit="return submitMsg()">
                    <table width="100%" border="0" cellpadding="3">
                      ...
                      <tr>
                        ...
                        <td><a href ="<?php echo $this->_var['order_info']['url']; ?>"><img src="themes/paimai/images/note.gif" /><?php echo $this->_var['order_info']['order_sn']; ?></a>
...
?> 
                  <a href="search.php?keywords=<?php echo urlencode($this->_var['tag']['tag_words']); ?>" class="f6"><?php echo htmlspecialchars($this->_var['tag']['tag_words']); ?></a> <a href="user.php?act=act_del_tag&amp;tag_words=<?php echo urlencode($this->_var['tag']['tag_words']); ?>" onclick="if (!confirm('<?php echo $this->_var['lang']['confirm_drop_tag']; ?>')) return false;" title="<?php echo $this->_var['lang']['drop']; ?>"><img src="themes/paimai/images/drop.gif" alt="<?php echo $this->_var['lang']['drop']; ?>" /></a>&nbsp;&nbsp; 
                  <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> 
                  <?php else: ?> 
...
?>
                  <tr>
                    <td><a href="<?php echo $this->_var['item']['url']; ?>" target="_blank"><?php echo $this->_var['item']['act_name']; ?></a></td>
                    <td><?php echo $this->_var['item']['end_time']; ?></td>
                    <td><?php echo $this->_var['item']['start_price']; ?></td>
                    <td><?php echo $this->_var['item']['bid_price']; ?></td>
                    <td><?php echo $this->_var['item']['my_bid_price']; ?></td>
                    <td><?php echo $this->_var['item']['my_bid_time']; ?></td>
                    <td><?php echo $this->_var['item']['text']; ?></td>
                  </tr>
                   <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                   <?php else: ?>
                   <tr>
                    <td align="left" bgcolor="#ffffff">你还没有参与任何商品竞拍！</td>
                  </tr> 
             <?php endif; ?>
             </table>
            </div>
