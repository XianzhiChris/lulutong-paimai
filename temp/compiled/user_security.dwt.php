							...
							<div class="m m5" id="safe05">
								...
								<div class="mc">
									...
									<div class="fore2">
										...
										<?php else: ?>
										<span class="ftx-03">您验证的手机：<?php echo $this->_var['info']['mobile_phone']; ?>,若已丢失或停用，请立即联系客服更换，避免账户被盗<?php endif; ?></span>
									</div>
									<div class="fore3">
										...
										<?php else: ?>
										<!--<input type="button" value="修改2" onclick="window.location.href='security.php?act=mobile_binding'" class="btn btn-7" />-->
										<?php endif; ?>
									</div>
								</div>
