...
$_LANG['template_files']['search_ysp'] = '艺术品列表页';   //增加艺术品列表页面 李云鹏20160520
...
$_LANG['template_files']['brand_list'] = '商品品牌列表页';  //增加品牌列表页面  李云鹏20160520
$_LANG['template_files']['auction_list'] = '拍卖活动列表';
$_LANG['template_files']['auction_lishi_list'] = '预示历史页面';  //增加预示历史页面 李云鹏20160520
$_LANG['template_files']['auction_xianshi_list'] = '限时拍页面';  //增加限时拍页面 李云鹏20160520
