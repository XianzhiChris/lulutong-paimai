...
elseif ($_REQUEST['act'] == 'insert')
{
    ...
    /* 添加图片类型的广告 增加幻灯片类型 李云鹏20140627*/
    if ($_POST['media_type'] == '0' || $_POST['media_type'] == '4')
    {
...
elseif ($_REQUEST['act'] == 'edit')
{
    ...
    if ($ads_arr['media_type'] == '0' || $ads_arr['media_type'] == '4') //增加新类型 李云鹏20160427
    {
    ...
    elseif ($ads_arr['media_type'] == 4)  //增加新类型 李云鹏20160427
    {
        $smarty->assign('media_type', "全屏幻灯片");
    }
...
function get_adslist()
{
    ...
    while ($rows = $GLOBALS['db']->fetchRow($res))
    {
         ...
         $rows['type'] .= ($rows['media_type'] == 4) ? "全屏幻灯片"  : ''; //增加新类型  李云鹏20160427
