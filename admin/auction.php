...
elseif ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update')
{
    ...
    $auction = array(
        ...
        'date'          => local_date('Y-m-d',local_strtotime($_POST['start_time'])),  //增加日期格式,方便预展历史栏目以日期分组  李云鹏20160514
        'is_xianshipai' => $_POST['is_xianshipai'],                                    //是否限时拍 李云鹏20160516
        'xianshipai_type'=>$_POST['xianshipai_type'],                                  //限时拍场次  李云鹏20160516
...
//    var_dump($auction);
//    exit;
//var_dump(local_strtotime($_POST['start_time']));
    /* 保存数据 */
    if ($is_add)
    {
