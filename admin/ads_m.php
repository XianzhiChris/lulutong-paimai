...
if ($_REQUEST['act'] == 'list')
{
    ...
    $smarty->assign('action_link', array('text' => '添加广告', 'href' => 'ads_m.php?act=add'));
...
elseif ($_REQUEST['act'] == 'insert')
{
    ...
    $link[1]['href'] = 'ads_m.php?act=list';

    $link[2]['text'] = $_LANG['continue_add_ad'];
    $link[2]['href'] = 'ads_m.php?act=add';
...
elseif ($_REQUEST['act'] == 'edit')
{
    ...
    $smarty->assign('action_link',   array('href' => 'ads_m.php?act=list', 'text' => $_LANG['ad_list']));
...
elseif ($_REQUEST['act'] == 'update')
{
   ...
   /* 提示信息 */
   $href[] = array('text' => $_LANG['back_ads_list'], 'href' => 'ads_m.php?act=list');
...
elseif ($_REQUEST['act'] == 'remove')
{
    ...
    $url = 'ads_m.php?act=query&' . str_replace('act=remove', '', $_SERVER['QUERY_STRING']);
